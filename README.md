...
> 🚀 Built with [App Generator](https://appseed.us/generator/), Timestamp: `2022-05-31 08:48`

- ✅ `Up-to-date dependencies`
- ✅ [Soft UI Design](https://www.creative-tim.com/product/soft-ui-design-system?AFFILIATE=128200) from `Creative-Tim`
- ✅ Database: `sqlite`
...
- move to the folder of your cloned repository
- install Flask, python3-venv, as well as the requirements.txt file
- create a virtual environment and activate it
- run the export commands from below
- start the app with 'flask run'
- deactivate the app with CTRL+C and exit the venv with 'deactivate'
